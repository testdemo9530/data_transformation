...
--  (
--     SELECT  
--     get_json_object(_airbyte_data, '$.address[0].city') AS city,
--     get_json_object(_airbyte_data, '$.address[0].line[0]') AS line1,
--     get_json_object(_airbyte_data, '$.address[0].line[1]') AS line2,
--     get_json_object(_airbyte_data, '$.address[0].postalCode') AS postalCode,
--     get_json_object(_airbyte_data, '$.address[0].state') AS statecode,
--     get_json_object(_airbyte_data, '$.birthDate') AS birthDate,
--     get_json_object(_airbyte_data, '$.deceasedDateTime') AS deceasedDateTime,
--     get_json_object(_airbyte_data, '$.gender') AS gender,
--     get_json_object(_airbyte_data, '$.id') AS id,
--     get_json_object(_airbyte_data, '$.name[0].family') AS family,
--     get_json_object(_airbyte_data, '$.name[0].given[0]') AS given1,
--     get_json_object(_airbyte_data, '$.name[0].given[1]') AS given2,
--     get_json_object(_airbyte_data, '$.name[0].use') AS name_use,
--     get_json_object(_airbyte_data, '$.resourceType') AS resourceType,
--     get_json_object(_airbyte_data, '$.extension[*].url') AS extension_url
-- from "Destination-S3"."gf-unveil"."new_dest".patient."2024_02_26_1708929073836_0.parquet"
--  )
--  select id,
--     resourceType,
--     city, 
